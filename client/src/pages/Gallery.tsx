  ...
  return (
    <main className="pt-20 min-h-screen bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          <h1 className="text-5xl font-bold text-primary mb-6">Complete Gallery</h1>
          <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
            Explore our complete collection of luxury furniture and interior design projects.
            Each piece represents our commitment to excellence, innovation, and timeless elegance.
          </p>
              ...
              >
                ...
                <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                  <div className="text-center text-white p-4">
                    <ZoomIn className="h-6 w-6 mx-auto mb-2" />
